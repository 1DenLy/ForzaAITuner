...
def test_load_ui_invalid_extension(tmp_path, qapp):
    ...
    with patch('desktop_client.presentation.helpers.ui_loader_service.SecurityUtils.validate_safe_path', return_value=test_file):
...
def test_load_ui_invalid_xml(tmp_path, qapp):
    ...
    with patch('desktop_client.presentation.helpers.ui_loader_service.SecurityUtils.validate_safe_path', return_value=empty_ui):
        with patch('desktop_client.presentation.helpers.ui_loader_service.SecurityUtils.validate_file_size'):
...
def test_load_ui_file_not_found(tmp_path, qapp):
    ...
    with patch('desktop_client.presentation.helpers.ui_loader_service.SecurityUtils.validate_safe_path', return_value=missing_file):
