...
![TimescaleDB](https://img.shields.io/badge/timescaledb-%23F6DF26.svg?style=flat&logo=timescaledb&logoColor=black)
...
- 💾 **Хранение данных**: Интеграция с PostgreSQL (метаданные) и TimescaleDB (потоковая телеметрия) для сохранения конфигураций тюнинга и гоночных сессий (поддержка гипертаблиц).
