...
class Ui_ConfigDialog(object):
    def setupUi(self, ConfigDialog):
        ...
        self.label_alignment_castor = QLabel(self.tab_alignment)
        self.label_alignment_castor.setObjectName(u"label_alignment_castor")
        self.label_alignment_castor.setMinimumSize(QSize(40, 10))
        self.label_alignment_castor.setMaximumSize(QSize(16777215, 20))
        self.label_alignment_castor.setFont(font1)
        self.label_alignment_castor.setAlignment(Qt.AlignCenter)

        self.gridLayout_castor_toe.addWidget(self.label_alignment_castor, 0, 1, 1, 2)
        ...
        self.tab_assists = QWidget()
        self.tab_assists.setObjectName(u"tab_assists")
        self.gridLayout_15 = QGridLayout(self.tab_assists)
        ...
        self.label_assists_steering = QLabel(self.tab_assists)
        ...
        self.label_assists_steering.setFont(font1)
        ...
        self.comboBox_assists_abs = QComboBox(self.tab_assists)
        self.comboBox_assists_abs.setObjectName(u"comboBox_assists_abs")
        sizePolicy1.setHeightForWidth(self.comboBox_assists_abs.sizePolicy().hasHeightForWidth())
        self.comboBox_assists_abs.setSizePolicy(sizePolicy1)
        ...
        self.comboBox_assists_stm = QComboBox(self.tab_assists)
        self.comboBox_assists_stm.setObjectName(u"comboBox_assists_stm")
        sizePolicy1.setHeightForWidth(self.comboBox_assists_stm.sizePolicy().hasHeightForWidth())
        self.comboBox_assists_stm.setSizePolicy(sizePolicy1)
        ...
        self.comboBox_assists_shifting = QComboBox(self.tab_assists)
        self.comboBox_assists_shifting.setObjectName(u"comboBox_assists_shifting")
        sizePolicy1.setHeightForWidth(self.comboBox_assists_shifting.sizePolicy().hasHeightForWidth())
        self.comboBox_assists_shifting.setSizePolicy(sizePolicy1)
        ...
        self.comboBox_assists_tcs = QComboBox(self.tab_assists)
        self.comboBox_assists_tcs.setObjectName(u"comboBox_assists_tcs")
        sizePolicy1.setHeightForWidth(self.comboBox_assists_tcs.sizePolicy().hasHeightForWidth())
        self.comboBox_assists_tcs.setSizePolicy(sizePolicy1)
        ...
        self.label_assists_shifting = QLabel(self.tab_assists)
        ...
        self.label_assists_shifting.setFont(font1)
        ...
        self.label_assists_abs = QLabel(self.tab_assists)
        ...
        self.gridLayout_15.addLayout(self.gridLayout_main_assists, 0, 0, 1, 1)

        self.verticalSpacer_difficulty_settings = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Preferred)

        self.gridLayout_15.addItem(self.verticalSpacer_difficulty_settings, 1, 0, 1, 1)

        self.tabWidget.addTab(self.tab_assists, "")
    ...
    def retranslateUi(self, ConfigDialog):
        ...
        self.label_alignment_castor.setText(QCoreApplication.translate("ConfigDialog", u"Castor", None))
        ...
        self.label_assists_steering.setText(QCoreApplication.translate("ConfigDialog", u"Steering", None))
        self.label_assists_shifting.setText(QCoreApplication.translate("ConfigDialog", u"Shifting", None))
        self.label_assists_abs.setText(QCoreApplication.translate("ConfigDialog", u"ABS", None))
        self.label_assists_tcs.setText(QCoreApplication.translate("ConfigDialog", u"TCS", None))
        self.label_assists_stm.setText(QCoreApplication.translate("ConfigDialog", u"STM", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_assists), QCoreApplication.translate("ConfigDialog", u"Assists", None))
    # retranslateUi
